...
export default class Database extends Component {
    ...
    constructor(props) {
        ...
        this.state = {
            ...
            loading: true,
            filters: [
                {text: "Reading", category: "goodFor", selected: false},
                {text: "Working", category: "goodFor", selected: false},
                {text: "Meeting", category: "goodFor", selected: false},
                {text: "Eating", category: "goodFor", selected: false},
                {text: "Grab and Go", category: "goodFor", selected: false},
